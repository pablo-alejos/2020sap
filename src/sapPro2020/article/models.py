...
class Journal(models.Model):
    ...
    quartMagazine = models.CharField(max_length=25,
                                     choices=quartile,
                                     verbose_name="Cuartiles")
    referenceMagazine = models.CharField(max_length=100,
                                         verbose_name="Enlace a revista",
                                         blank=True)
...
class Article(models.Model):
    ...
    journal = models.ForeignKey(Journal,
                                on_delete=models.PROTECT,
                                verbose_name="Nombre de revista")
    ...
    authors = models.ManyToManyField(Author,
                                     blank=True,
                                     verbose_name="Otros Autores")
    tags = models.ManyToManyField(Tag, blank=True, verbose_name="Etiquetas")
    #Fields
    title = models.CharField(max_length=220,
                             verbose_name="Título de artículo",
                             unique=True)
    indexed = models.BooleanField(default=False,
                                  verbose_name="Indizado",
                                  blank=True,
                                  null=True)
    indexInfo = models.CharField(max_length=220,
                                 verbose_name="Índice en que se encuentra",
                                 blank=True,
                                 null=True)
    ...
    pages = models.CharField(max_length=50,
                             verbose_name="Páginas donde está publicado")
    status = (
    ...
    timeStamp = models.DateTimeField(auto_now_add=True,
                                     verbose_name="Time Stamp")
    product = models.CharField(default="Articulo",
                               editable=False,
                               max_length=15)
