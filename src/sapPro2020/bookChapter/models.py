...
class BookChapter(models.Model):
    ...
    title = models.CharField(max_length=100,
                             verbose_name="Nombre del capitulo",
                             unique=True)
    bookTitle = models.CharField(max_length=100,
                                 verbose_name="Titulo del libro")
    bookEditorial = models.CharField(max_length=100,
                                     blank=True,
    ...
    file = models.FileField(upload_to='archiving/',
                            verbose_name="Capitulo de libro (PDF)",
                            unique=True)
    ...
    product = models.CharField(default="Capitulo",
                               editable=False,
                               max_length=15)
    ...
    def get_absolute_url(self):
        return reverse("bookChapter:bookChapter-detail",
                       kwargs={"id": self.id})
