...
class Book(models.Model):
    ...
    #ManyToManyFields    
    authors = models.ManyToManyField(Author,blank=True,verbose_name = "Todos los Autores")
    tags = models.ManyToManyField(Tag, blank=True, verbose_name="Etiquetas")
    #Fields 
    title = models.CharField(max_length=220, verbose_name="Titulo del libro",unique=True)
    ...
    file = models.FileField(upload_to="archiving/", verbose_name="Libro (PDF)",unique=True)
